    ...
    <div className="![perspective:900px] ![transform-style:preserve-3d]">
      ...
      >
        ...
        >
          ...
          {showDescription && (
            <div className="!absolute inset-0 flex flex-col items-center justify-center p-[4vmin] bg-black/50 text-white">
              <p className="text-center !mx-5 text-[8px] md:text-base">{Description}</p>
              <button
                onClick={(e) => {
                  e.stopPropagation();
          ...
          >
            ...
            <div className="flex justify-center">
              <button
                ...
                className="md:!mt-10 !mt-12 sm:!mt-20 md:!px-4 !px-2 !py-2 md:!py-2 w-fit !mx-auto text-sm text-black bg-white md:h-12 border border-transparent text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"
              >
                {button}
              </button>
            </div>
