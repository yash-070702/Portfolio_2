...
<div ref={counterRef} className="text-center !py-3 md:w-max !px-10 !mx-12 md:!mx-0  bg-[#1e4e76] rounded-3xl">
      <h2 className=" text-2xl md:text-3xl font-bold !pt-5 text-[#ffffff9c]">Achievements</h2>
...
initial={{ opacity: 0, x: 100 }} // Start from right (+100px)
 ...
 className="flex flex-col justify-center gap-10  whitespace-pre-line !p-5 md:!p-10">
    <h2 className="text-5xl font-bold text-amber-50 py-10 text-center self-center">About Me</h2>
    <div className="text-[#ffffff9c] md:text-xl  whitespace-pre-line  text-center">Hi, I'm <p className="inline font-bold underline italic">Yash Aggarwal</p>, a pre-final year <p className="inline font-bold">Computer Science Engineering student at KIET Group of Institutions</p>. As the Technical Lead of Kinesis Technical Society, I have had the privilege of mentoring over <p className="inline font-bold underline"> 100+ students,</p> guiding them in their tech journeys. Passionate about building scalable solutions, I am currently working on my own platform,<p className="inline font-bold underline">@SYV.</p>  With expertise as a MERN stack developer and a strong foundation in competitive programming, I am eager to gain industry exposure through an internship in the field of development. Always ready to innovate and solve real-world problems, I thrive on challenges that push my technical and problem-solving skills to the next level."</div>
    {/* CTA BUttons */}
